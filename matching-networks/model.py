...
from tensorflow.keras.layers import BatchNormalization, ReLU, MaxPool2D
...
class MatchingNetwork(Model):
    def __init__(self, way, w, h, c, lstm_size=32, batch_size=32):
        ...
        self.fce = tf.keras.Sequential([Bidirectional(tf.keras.layers.LSTM(lstm_size, return_sequences=True))])
